...
ActiveRecord::Schema[7.0].define(version: 2022_06_07_210337) do
  ...
  create_table "employees", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["deparment_id"], name: "index_employees_on_deparment_id"
  end

  add_foreign_key "employees", "deparments"
end
